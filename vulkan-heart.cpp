...
void drawFrame(const std::vector<Vertex> &vertices, const std::vector<uint16_t> &indices) {
    ...
    recordCommandBuffer(commandBuffers[currentFrame], imageIndex, vertices, indices);
